...
namespace VRTK
{
    ...
    public class VRTK_BodyPhysics : VRTK_DestinationMarker
    {
        ...
        [SerializeField]
        protected string LayerIgnoreSTRING = "Ignore Raycast";
        ...
        protected virtual GameObject CreateColliderContainer(string name, Transform parent)
        {
            ...
            generatedContainer.layer = LayerMask.NameToLayer(LayerIgnoreSTRING);
        ...
        protected virtual void GenerateBodyCollider()
        {
            if (bodyColliderContainer == null)
            {
                ...
                else
                {
                    ...
                    bodyColliderContainer.gameObject.layer = LayerMask.NameToLayer(LayerIgnoreSTRING);
                }
        ...
        protected virtual void GenerateFootCollider()
        {
            if (CalculateStepUpYOffset() > 0f)
            {
                ...
                else
                {
                    ...
                    footColliderContainer.gameObject.layer = LayerMask.NameToLayer(LayerIgnoreSTRING);
                }
        ...
        protected virtual void CreateCollider()
        {
            ...
            {
                playArea.gameObject.layer = LayerMask.NameToLayer(LayerIgnoreSTRING);
            }
            TogglePhysics(enableBodyCollisions);
        }
